export default function BottomPanel() {
  return (
    <div className="flex p-10 justify-center">
      ...
      <div className="bg-rose-200 px-24 ml-12 rounded-3xl flex flex-col items-center">
        <h2 className="font-semibold text-3xl mt-8">500+</h2>
        <p className="mb-4">Total Clients</p>
        <div class="flex">
          <div class="absolute right-64 z-20">
            <img src="/person.jpg" alt="Person 1" class="h-14 rounded-full" />
          </div>
          <div class="absolute right-56 z-10">
            <img src="/person.jpg" alt="Person 2" class="h-14 rounded-full" />
          </div>
          <div class="absolute right-48">
            <img src="" alt="Person 3" class="bg-black h-14 rounded-full" />
            <p className="absolute left-6 bottom-4 text-white">+2</p>
          </div>
        </div>
      </div>
    </div>
